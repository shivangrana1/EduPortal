...
<head>
    ...
    <title>EduPortal - My Courses</title>
    ...
    <style>
        ...
        .course-card { background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 2px 15px rgba(0,0,0,0.08); margin-bottom: 25px; transition: transform 0.3s; }
        .course-card:hover { transform: translateY(-5px); }
        .course-header { background: linear-gradient(135deg, #11998e, #38ef7d); padding: 25px; color: white; }
        .course-header h5 { font-weight: 700; margin: 0; }
        .course-body { padding: 20px; }
        .btn-create { background: linear-gradient(135deg, #11998e, #38ef7d); border: none; color: white; border-radius: 10px; padding: 10px 20px; font-weight: 600; }
...
<div class="sidebar">
    ...
    <nav>
        ...
        <a href="<%= request.getContextPath() %>/course?action=teacherCourses" class="nav-link active">
            ...
            <div class="col-md-4">
                <div class="course-card">
                    <div class="course-header">
                        ...
                        <small><i class="fas fa-tag me-1"></i><%= course.getCategory() %></small>
                    </div>
