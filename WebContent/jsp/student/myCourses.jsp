...
<head>
    ...
    <style>
        ...
        .btn-continue:hover { opacity: 0.9; color: white; }
    </style>
</head>
<body>
...
<div class="sidebar">
    ...
    <nav>
        ...
        <a href="<%= request.getContextPath() %>/course?action=myCourses" class="nav-link active">
...
<div class="main-content">
    ...
    <% if (courses == null || courses.isEmpty()) { %>
        <div class="text-center py-5">
            ...
            <p class="text-muted">Browse and enroll in courses to get started!</p>
